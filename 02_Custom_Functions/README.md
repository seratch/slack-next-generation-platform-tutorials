...
If you're new to the platform, please read my [The Simplest "Hello World" tutorial](https://dev.to/seratch/slack-next-gen-platform-the-simplest-hello-world-4ic0) first. In a nutshell, you'll need a paid Slack workspace, permission to use the beta feature in the workspace, and then connect your Slack CLI with the workspace.

If everything is already done, you're ready to build your first app. Let's get started!
